...
@Service
public class OpenApiAescryptoServiceImpl implements OpenApiAescryptoService {

    private static final Logger logger = LoggerFactory.getLogger(OpenApiAescryptoServiceImpl.class);


    @Override
    public String Aescrypto(String txtPassword)throws Exception{

        logger.info("##################################### OpenApiAescryptoServiceImpl : " + txtPassword);

        //AesCrypto AesCrypto = new AesCrypto();
        String key = "sBcertNonStd";

        String Encrypt = Encrypt(txtPassword, key);
