		...
		<form>
			<table class="table table-striped"
				...
				<thead>
					<tr>
						<th colspan="22"
							style="background-color: #00CC00; color: white; text-align: center;">OpenAPI 전자세금계산서
							발행</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td class="DTILeftText" colspan="3"><input type="text"
							id="txtDtiWdate" name="txtDtiWdate" value="20201006"
							maxlength="100" size="17" /></td>
			...
			<input type="button" onclick="ARISSUE();" id="oapiissue" class="btn btn-primary pull-right"
				value="거래명세서발행">
...
<script src="js/smartbillOAPI.js"></script>
