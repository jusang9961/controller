...
<div class="container">
	<div class="row">
		<form method="post" action="smartbillNewArissueDttPost" onsubmit="return issueCheck();">
			<table class="table table-striped"
				style="text-align: center; border: 1px #dddddd">
				<thead>
					<tr>
						<th colspan="22"
							style="background-color: #FF0000; color: white; text-align: center;">차세대 전자(세금)계산서/거래명세서 발행</th>
					</tr>
				</thead>
				<tbody>
					<tr>
