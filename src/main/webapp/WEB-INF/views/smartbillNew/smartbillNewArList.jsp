	...
	<div class="row">
		<form method="post" >
			...
			<thead>
				<tr>
					<th colspan="22"
						style="background-color: #FF0000; color: white; text-align: center;">차세대 전자(세금)계산서 매출 보관함</th>
					</tr>
				<tr>
...
// checkbox.parent() : checkbox의 부모는 <td>이다.
        ...
        window.open("http://192.168.100.118:30000/dti/api/v1/view/" + tdArr + "?stype=AR");
